 ...
 */
class NewsSmi extends Model implements ContractsTranslatable
{
    use Log, Publish, Slug, Columns, Translatable, Lang;

    protected $table = 'news_smi';
    ...
    protected $translationModel = NewsSmiTranslation::class;
    ...
    public function url()
    {
        $resource = Page::where('behavior', 'news-smi')->first();
